...
## D-010 — Use a 40-second observed live panel-generation target

- Date: 2026-07-21
- Status: Accepted
- Context: D-007's tuned matched reference-panel requests measured 31.272 and
  32.335 seconds and retained the violet jacket, round goggles, curly hair,
  and moon-kite spool. Six later Task 8 panel-image runs measured 26.049,
  27.737, 28.654, 35.641, 36.151, and 38.477 seconds (mean 32.118 seconds,
  median 32.148 seconds, maximum 38.477 seconds). Three of six exceeded
  D-007's 35-second value; none exceeded 40 seconds.
- Decision: Supersede D-007 with a 40-second observed live panel-generation
  target.
